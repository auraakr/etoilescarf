<aside id="top-bar-sidebar" class="bg-white fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
      <a href="/" class="flex items-center ps-2.5 mb-5">
         <!-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-6 me-3" alt="Flowbite Logo" /> -->
         <span class="self-center text-lg text-heading font-semibold whitespace-nowrap">Etoile Scarf</span>
      </a>
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <x-nav-link href="{{ route('admin.categories.index') }}" :active="request()->routeIs('admin.categories.index')">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">{{ __('Products Categories') }}</span>
            </x-nav-link>
         </li>
         <li>
            <x-nav-link href="{{ route('admin.transactions.index') }}" :active="request()->routeIs('admin.transactions.*')">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">{{ __('Transactions') }}</span>   
            </x-nav-link>
         </li>
      </ul>
   </div>
